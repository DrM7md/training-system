...
export default function Index({ payments, assignmentTypes, paymentMonths, filters, grandTotal }: Readonly<Props>) {
                                ...
                                {payments.map((row, i) => (
                                    <>
                                        <tr key={row.trainer.id} className="hover:bg-slate-50/50 transition-colors">
                                            ...
                                            <td className="px-4 py-3 text-slate-600 text-xs">{row.trainer.nationality_category || '-'}</td>
                                            ...
                                            <tr key={`detail-${row.trainer.id}`}>
                                                <td colSpan={8} className="px-6 py-3 bg-slate-50/80">
                                                    ...
                                                    <div className="mt-2 pt-2 border-t border-slate-200 text-left">
                                                        <span className="text-xs text-slate-500">المعادلة: عدد الساعات × قيمة الساعة × عدد المجموعات</span>
                                                    </div>
                                                </td>
                                            </tr>
                                        )}
